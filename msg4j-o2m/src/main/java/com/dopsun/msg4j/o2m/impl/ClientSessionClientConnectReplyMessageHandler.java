 ...
 * @since 1.0.0
 */
final class ClientSessionClientConnectReplyMessageHandler extends ClientMessageHandler {

    /**
     * @param context
     */
    public ClientSessionClientConnectReplyMessageHandler(ClientMessageHandlerContext context) {
        super(context);
    }
