 ...
 * @since 1.0.0
 */
public class O2mServiceException extends Exception {
    private static final long serialVersionUID = 4153991219606314136L;

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not
     * initialized, and may subsequently be initialized by a call to {@link #initCause}.
     */
    public O2mServiceException() {
        super();
    }
     ...
     */
    public O2mServiceException(String message) {
        super(message);
    }
     ...
     *            or unknown.)
     */
    public O2mServiceException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *            or unknown.)
     */
    public O2mServiceException(Throwable cause) {
        super(cause);
    }
}
