...
abstract class ActiveMQTransportDestination implements TransportDestination {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || (!(obj instanceof ActiveMQTransportDestination))) {
            return false;
        }

        ActiveMQTransportDestination another = (ActiveMQTransportDestination) obj;
